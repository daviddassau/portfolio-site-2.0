...
if (!function_exists('wp_blog_designer_enqueue_color_picker')) {
    ...
    function wp_blog_designer_enqueue_color_picker($hook_suffix) {
        ...
        if (isset($_GET['page']) && ($_GET['page'] == 'designer_settings' || $_GET['page'] == 'bd_getting_started') || $hook_suffix == 'plugins.php') {
    ...
    function wp_blog_designer_redirection() {
        if (get_option('bd_plugin_do_activation_redirect', false)) {
            ...
            if (!isset($_GET['activate-multi'])) {
                wp_redirect("admin.php?page=bd_getting_started");
            }
        }
    }
}
...
if (!function_exists('wp_blog_designer_admin_stylesheet')) {
    ...
    function wp_blog_designer_admin_stylesheet() {
        ...
        if ((isset($_GET['page']) && ( $_GET['page'] == 'designer_settings' || $_GET['page'] == 'bd_getting_started')) || $screen->id == 'dashboard' || $screen->id == "plugins") {
                            ...
                            <ul class="bd-settings">
                                ...
                                <li class="bd-caution">
                                    <div class="bdp-setting-caution">
                                        ...
                                        <?php
                                        _e('You are about to select the page for your layout. This will overwrite all the content on the page that you will select. Changes once lost conn ot be recovered. Please be cautious!', 'blog-designer');
                                        ?>
                                    </div>
                                    <div class="bd-left">
                            ...
                            <ul class="bd-settings">
                                <li>
                                    ...
                                    <div class="bd-right">
                                        ...
                                        <input type="text" name="main_container_class" id="main_container_class" placeholder="<?php esc_attr_e('Enter main cover class name', 'blog-designer'); ?>" value="<?php echo isset($settings["main_container_class"]) ? $settings["main_container_class"] : ''; ?>"/>
                                    </div>
                                </li>
                        ...
                        <div id="bdpmedia" class="postbox postbox-with-fw-options" <?php echo $bdpmedia_class_show; ?>>
                            <ul class="bd-settings">
                                <li class="pro-feature">
                                    ...
                                    <div class="bd-right">
                                        <span class="fas fa-question-circle bd-tooltips-icon"><span class="bd-tooltips"><?php _e('Enable/Disable post image link'); ?></span></span>
                                        <fieldset class="buttonset">
                ...
                <div class="useful_plugins">
                    ...
                    <div class="help-wrapper">
                        <div class="pro-content">
                            ...
                            <p class="pricing_change"><?php _e("Now only at", 'blog-designer'); ?> <ins>34</ins></p>
                        </div>
    ...
    function bd_subscribe_mail() {
        ...
        <script type="text/javascript">
         jQuery.getJSON("http://freegeoip.net/json/", function(result){
            var customer_country = result.country_code;
            jQuery('#txtCountry').val(customer_country);
        });
        </script>
        <?php
        if (isset($_POST['sbtEmail'])) {
            ...
            $customer_country = trim($_POST['txtCountry']);
            ...
            <div id="subscribe_widget_bd" style="display:none;">
                <div class="subscribe_widget">
                    ...
                    <form class='sub_form' name="frmSubscribe" method="post" action="<?php echo admin_url() . 'admin.php?page=designer_settings'; ?>">
                        <div class="sub_row"><label><?php _e('Your Name: ', 'blog-designer'); ?></label><input placeholder="Your Name" required name="txtName" type="text" value="" /></div>
                        <div class="sub_row"><label><?php _e('Email Address: ', 'blog-designer'); ?></label><input placeholder="Email Address" required name="txtEmail" type="email" value="" /></div>
        ...
        <div id="sol_deactivation_widget_cover_bd" style="display:none;">
            <div class="sol_deactivation_widget">
                ...
                <form id="frmDeactivationbd" name="frmDeactivation" method="post" action="">
                    ...
                    <input type="hidden" name="bd_deactivation_option_country" id="bd_deactivation_option_country" value="" />
                ...
                <div class="support-ticket-section">
                    ...
                    <img src="http://192.168.10.78/tanvi/multi_plugin/blog-designer-lite/wp-content/uploads/sites/17/2018/03/support-ticket.png">
                    <a href="http://support.solwininfotech.com/"><?php _e('Create a support ticket', 'blog-designer'); ?></a>
                </div>
            </div>
...
if (!function_exists('bd_plugin_links')) {
    ...
    function bd_plugin_links($links) {
        $action_links = array(
            'settings' => '<a href="' . admin_url('admin.php?page=designer_settings') . '" title="' . esc_attr(__('View Blog Designer Settings', 'blog-designer')) . '">' . __('Settings', 'blog-designer') . '</a>'
        );
...
if (!function_exists('db_sbt_deactivation_form')) {
    ...
    function db_sbt_deactivation_form() {
        ...
        $bd_deactivation_option_country = $_POST['bd_deactivation_option_country'];
        $headers = "MIME-Version: 1.0;\r\n";
        $headers .= "From: " . strip_tags($from) . "\r\n";
        $headers .= "Content-Type: text/html; charset: utf-8;\r\n";
        $headers .= "X-Priority: 3\r\n";
                            ...
                            <table border='0' cellpadding='5' cellspacing='0' style="font-family: Arial, Helvetica, sans-serif; font-size: 13px;color: #333333;width: 100%;">
                                ...
                                <tr style="border-bottom: 1px solid #eee;">
                                 ...
                                 <tr style="border-bottom: 1px solid #eee;">
                                    ...
                                    <td style="padding: 8px 5px;">
                                        <?php echo $bd_deactivation_option_country; ?>
                                    </td>
                                </tr>
                                <tr style="border-bottom: 1px solid #eee;">
                                    <th style="padding: 8px 5px; text-align: left; width: 120px;">
