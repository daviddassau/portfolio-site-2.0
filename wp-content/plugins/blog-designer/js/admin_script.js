...
jQuery(window).load(function () {
    ...
    jQuery('#sbtDeactivationFormbd').click(function (event) {
        ...
        var bd_deactivation_option_country = jQuery("#bd_deactivation_option_country").val();
        jQuery.ajax({
            url: ajaxurl,
            method: 'POST',
            data: {
                ...
                'bd_deactivation_option_country': bd_deactivation_option_country
            },
            complete: function () {
    ...
    function change_thickbox_size() {
        jQuery(document).find('#TB_window').width('750').height('400').css('margin-left', -700 / 2);
