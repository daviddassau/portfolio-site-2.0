    ...
    */
    ...
    public function ucmm_row_meta( $links, $file ) {
      ...
      if ( strpos( $file, UCMM_WPBRIGADE_MAIN_FILE ) !== false ) {
        ...
        $new_links = array('<a href="https://wordpress.org/support/view/plugin-reviews/under-construction-maintenance-mode/" target="_blank"><span class="dashicons dashicons-thumbs-up"></span> ' . __( 'Vote!', 'ucmm-wpbrigade' ) . '</a>',
        );
    ...
    public function ucmm_admin_scripts() {
      ...
      */
      wp_localize_script( 'ucmm-js', 'mc_api', array(
    ...
    function ucmm_deactivate() {
      ...
      $response = wp_remote_post( UCMM_WPBRIGADE_FEEDBACK_SERVER, array(
        'method'      => 'POST',
        'timeout'     => 5,
        'httpversion' => '1.0',
        'blocking'    => false,
