 ...
 */
	...
	*/
	...
	function onepage_parallax_styles() {
		...
		wp_enqueue_style( 'font-awesome', ONEPAGE_PARALLAX_DIR_URI . 'assets/css/font-awesome.min.css', array(), onepage_parallax_version() );
	...
	function onepage_parallax_scripts() {
		...
		wp_enqueue_script( 'onepage_parallax_script', ONEPAGE_PARALLAX_DIR_URI . 'assets/js/script.js', array( 'jquery' ), onepage_parallax_version(), true );
