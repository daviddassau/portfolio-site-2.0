    ...
    <div class="wpb_about section" id="about-us">
      <div class="container-fluid">
        <div class="wpb_abt_hd animJs" data-anim="slideUp">
          <h2><?php echo esc_html( get_theme_mod( 'onepage_parallax_about_title', esc_html__('About Us', 'onepage-parallax') ) ); ?></h2>
          <p class="display-4"><?php echo esc_html( get_theme_mod( 'onepage_parallax_about_subtitle', esc_html__('Who are we and what are we doing', 'onepage-parallax') ) ); ?></p>
        </div>
        <div class="row no-gutters">
          ...
          if ( ! empty( $onepage_parallax_aboutus_mod ) ) {
            ...
            $onepage_parallax_repeater_aboutus_decoded = json_decode( $onepage_parallax_repeater_about );
              ...
              foreach ( $onepage_parallax_repeater_aboutus_decoded as $onepage_parallax_about_item ) :
                ...
                <div class="<?php echo $onepage_parallax_aboutus_tr_class; ?> about_items animJs"  data-anim="slideUp">
                  ...
                  <div class="abt_sec-1">
                    ...
                    <?php
                    if ( 'on' == $onepage_parallax_about_item->pages_image ) {
                      ?>
                      <div class="abt_imgs">
                    ...
                    <h4 class="display-4"><?php if ( !empty ( $onepage_parallax_about_item->subtitle ) ) { echo esc_html( $onepage_parallax_about_item->subtitle ); } ?></h4>
                    ...
                    <p class="<?php echo 'aboutus_disc' . $onepage_parallax_about_count; ?>"> <?php echo $onepage_parallax_about_content;  ?>
                    </p>
                  </div>

                  <?php if ( !empty( $onepage_parallax_about_item->pages_link ) && 'on' == $onepage_parallax_about_item->pages_link ) { ?>
                    <a href="<?php echo esc_url( $onepage_parallax_repeater_aboutus_link ); ?>" target="_blank" class="find_more_btn"> <?php echo esc_html_e( 'find out more', 'onepage-parallax' ); ?> </a>
                  <?php  } ?>
