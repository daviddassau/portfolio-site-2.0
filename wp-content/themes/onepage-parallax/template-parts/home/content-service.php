    ...
    <div class="wpb_services bg-faded more_padding section" id="services">
      <div class="container-fluid">
        <div class="text-center mb-5 animJs" data-anim="slideUp">
          <h2><?php echo esc_html( get_theme_mod( 'onepage_parallax_service_title', __( 'Services', 'onepage-parallax' ) ) ); ?></h2>
          <p class="display-4"><?php echo esc_html( get_theme_mod( 'onepage_parallax_service_subtitle', __( 'What can we help you with?', 'onepage-parallax' ) ) ); ?></p>
        </div>
        <div class="row">
          <?php
          $onepage_parallax_service_mod = get_theme_mod( 'onepage_parallax_service_items' );
          if ( ! empty( $onepage_parallax_service_mod ) ) :
                ...
                <div class="<?php echo $onepage_parallax_service_tr_class; ?> animJs" data-anim="slideUp">
                  <div class="service_box">
                    ...
                    <div class="service_txt">
                      ...
                      <?php } ?>
                      <div class="service-content"><?php echo esc_html( $onepage_parallax_services_content ); ?></div>
                    </div>
                  </div>
                </div>
                <?php
