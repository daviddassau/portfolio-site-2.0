          ...
          foreach ( $onepage_parallax_repeater_success_decoded as $onepage_parallax_item_success ) :
            ...
            <div class="col-md-6 col-lg-3 animJs" data-anim="slideUp">
              <div class="goal_sec-1">
                <p class="display-1"><?php echo esc_html( $onepage_parallax_item_success->title ); ?></p>
                <h4><?php echo wp_kses( $onepage_parallax_item_success->subtitle , array(
                  'br' => array(),
                  'strong' => array(),
                  'b' => array(),
                  'em' => array(),
              ...
              <div class="rounded-circle m-auto goal_circle_sec">
                <?php
                if ( ! empty( $onepage_parallax_item_success->image_url ) ) {
                  ?>
                  ...
                  <!-- <span class="<?php //echo $onepage_parallax_success_class[ $onepage_parallax_success_count - 1 ]; echo ' onepage_parallax_service_img_' . $onepage_parallax_success_count; ?> "> </span> -->
                  <?php
                }
                ?>
