            ...
            <div class="item">
              ...
              <div class="slider_inner_content">
                ...
                <div class="team-detail">
                  <?php echo wp_kses_post( $onepage_parallax_team_content ); ?>
                </div>
                <?php
                ...
                if ( isset( $onepage_parallax_social_repeater ) ) :
                  ...
                  <a href="<?php echo esc_url( $onepage_parallax_social_repeater->link ); ?>"><i class="fa <?php echo esc_attr( $onepage_parallax_social_repeater->icon );?>" aria-hidden="true"></i></a>
                <?php endforeach;
              endif;
              ?>
            </div>
