            ...
            <div class="col-lg-9 get_in_touch_sec">
                <div class="row no-gutters">
                    <div class="col-lg-6 pt-3">
                        ...
                        <a href="tel:0044 0569 852 369" class="d-block text-white font-weight-bold cell_no"><?php echo $onepage_parallax_getintouch_text_3; ?></a>
                    </div>
                    <div class="col-lg-2 pt-3"><span class="m-auto text-center rounded-circle or d-block text-white"><?php esc_html_e( 'Or', 'onepage-parallax' ) ?></span></div>
                    <div class="col-8 col-md-4 pt-3 m-auto">
                        <a href="#contact"><button class="btn msg_btn w-100 text-white font-weight-bold py-3"><?php echo $onepage_parallax_getintouch_text_4; ?></button></a>
                        <a href="#contact"><button class="btn msg_btn w-100 text-white font-weight-bold py-3"><?php echo $onepage_parallax_getintouch_text_4; ?></button></a>
                    </div>
                </div>
            </div>
